...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:4:0x0011, code lost:
        r3 = kotlin.text.StringsKt.substringBeforeLast$default((r3 = r3.toString()), mil.nga.geopackage.property.PropertyConstants.PROPERTY_DIVIDER, (java.lang.String) null, 2, (java.lang.Object) null);
     */
    ...
    private static final Path setLastModifiedTime(Path path, FileTime fileTime) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(fileTime, DataColumnConstraints.COLUMN_VALUE);
    ...
    private static final Path setOwner(Path path, UserPrincipal userPrincipal) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(userPrincipal, DataColumnConstraints.COLUMN_VALUE);
    ...
    private static final Path setPosixFilePermissions(Path path, Set<? extends PosixFilePermission> set) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(set, DataColumnConstraints.COLUMN_VALUE);
