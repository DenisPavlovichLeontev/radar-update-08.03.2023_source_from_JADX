    ...
    public static final long commonIndexOf(Buffer buffer, ByteString byteString, long j) {
        ...
        if (byteString.size() > 0) {
            ...
            if (j >= 0) {
                ...
                while (j2 < size5) {
                    byte[] bArr2 = segment4.data;
                    int min2 = (int) Math.min((long) segment4.limit, (((long) segment4.pos) + size5) - j2);
                    segment = segment4;
                    int i3 = (int) ((((long) segment.pos) + j8) - j2);
                    if (i3 < min2) {
                        while (true) {
                            int i4 = i + 1;
                            z = true;
                            if (bArr2[i] == b2 && rangeEquals(segment, i4, internalArray$okio2, 1, size4)) {
                                break loop4;
                            } else if (i4 >= min2) {
                                break;
                            } else {
                    ...
                    j7 = j2 + ((long) (segment.limit - segment.pos));
                    segment4 = segment.next;
                    Intrinsics.checkNotNull(segment4);
                    j8 = j7;
                    boolean z3 = z;
                }
