...
public final class _PathKt {
    ...
    /* access modifiers changed from: private */
    public static final ByteString DOT = ByteString.Companion.encodeUtf8(PropertyConstants.PROPERTY_DIVIDER);
    /* access modifiers changed from: private */
    ...
    public static final Path commonRelativeTo(Path path, Path path2) {
        ...
        if (Intrinsics.areEqual((Object) path.getRoot(), (Object) path2.getRoot())) {
            ...
            if (i == min && path.getBytes$okio().size() == path2.getBytes$okio().size()) {
                return Path.Companion.get$default(Path.Companion, PropertyConstants.PROPERTY_DIVIDER, false, 1, (Object) null);
            }
