...
@DebugMetadata(mo20608c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", mo20609f = "Deprecated.kt", mo20610i = {0, 0, 1, 1}, mo20611l = {487, 242}, mo20612m = "filterNotNullTo", mo20613n = {"destination", "$this$consume$iv$iv", "destination", "$this$consume$iv$iv"}, mo20614s = {"L$0", "L$1", "L$0", "L$1"})
