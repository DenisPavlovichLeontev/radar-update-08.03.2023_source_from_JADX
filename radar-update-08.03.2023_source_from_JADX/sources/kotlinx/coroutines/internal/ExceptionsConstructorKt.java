...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        try {
            ...
            e2 = Result.m200constructorimpl(((CopyableThrowable) e).createCopy());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            e2 = Result.m200constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m206isFailureimpl(e2)) {
            e2 = null;
        }
        return (Throwable) e2;
    }
    ...
    public static final <E extends Throwable> Function1<Throwable, Throwable> createConstructor(Class<E> cls) {
        ...
        for (Constructor createSafeConstructor : ArraysKt.sortedWith((T[]) cls.getConstructors(), new C1150x1af7bbab())) {
    ...
    private static final Function1<Throwable, Throwable> createSafeConstructor(Constructor<?> constructor) {
        ...
        if (length == 1) {
            ...
            return new C1151x18164153(constructor);
        } else {
            return null;
        }
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            num = Result.m200constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, (Object) null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            num = Result.m200constructorimpl(ResultKt.createFailure(th));
        }
        Integer valueOf = Integer.valueOf(i);
        if (Result.m206isFailureimpl(num)) {
            num = valueOf;
        }
