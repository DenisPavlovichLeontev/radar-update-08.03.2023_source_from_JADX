...
public final class WorkQueue {
    ...
    public final long tryStealBlockingFrom(WorkQueue workQueue) {
        ...
        for (int i2 = workQueue.consumerIndex; i2 != i; i2++) {
            ...
            if (task != null) {
                if ((task.taskContext.getTaskMode() == 1) && ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m132m(atomicReferenceArray, i3, task, (Object) null)) {
    ...
    private final long tryStealLastScheduled(WorkQueue workQueue, boolean z) {
        ...
        } while (!C0125xc40028dd.m4m(lastScheduledTask$FU, workQueue, task, (Object) null));
        add$default(this, task, false, 2, (Object) null);
        return -1;
    }
