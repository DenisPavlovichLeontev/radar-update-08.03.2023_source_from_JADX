...
@DebugMetadata(mo20608c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", mo20609f = "Limit.kt", mo20610i = {0}, mo20611l = {153}, mo20612m = "invokeSuspend", mo20613n = {"collector$iv"}, mo20614s = {"L$0"})
...
final class FlowKt__LimitKt$transformWhile$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        C1087xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Flow<T> flow = this.$this_transformWhile;
            C1087xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$12 = new C1087xdf1aa1b6(this.$transform, (FlowCollector) this.L$0);
            try {
            ...
            flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 = (C1087xdf1aa1b6) this.L$0;
            try {
                ResultKt.throwOnFailure(obj);
