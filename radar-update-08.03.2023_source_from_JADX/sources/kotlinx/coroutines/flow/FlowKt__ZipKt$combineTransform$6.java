...
@DebugMetadata(mo20608c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo20609f = "Zip.kt", mo20610i = {}, mo20611l = {251}, mo20612m = "invokeSuspend", mo20613n = {}, mo20614s = {})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo20608c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo20609f = "Zip.kt", mo20610i = {}, mo20611l = {251}, mo20612m = "invokeSuspend", mo20613n = {}, mo20614s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C11352 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C11352 r0 = new C11352(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C11352((Continuation<? super C11352>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C11352((Continuation<? super C11352>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
