...
class TwilightManager {
    ...
    private void updateState(Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - OpenStreetMapTileProviderConstants.ONE_DAY, location.getLatitude(), location.getLongitude());
        ...
        long j6 = j3;
        boolean z3 = z2;
        instance.calculateTwilight(OpenStreetMapTileProviderConstants.ONE_DAY + currentTimeMillis, location.getLatitude(), location.getLongitude());
        long j7 = instance.sunrise;
        if (j6 == -1 || j5 == -1) {
            j = 43200000 + currentTimeMillis;
        } else {
            j = (currentTimeMillis > j5 ? 0 + j7 : currentTimeMillis > j6 ? 0 + j5 : 0 + j6) + OpenStreetMapTileProviderConstants.ONE_MINUTE;
        }
