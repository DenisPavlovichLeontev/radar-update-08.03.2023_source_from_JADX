...
class AlertController {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0019R.C0022id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0019R.C0022id.scrollIndicatorDown);
