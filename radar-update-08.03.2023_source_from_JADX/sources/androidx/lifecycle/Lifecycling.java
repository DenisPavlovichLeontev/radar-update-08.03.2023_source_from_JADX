...
public class Lifecycling {
    ...
    private static Constructor<? extends GeneratedAdapter> generatedConstructor(Class<?> cls) {
        try {
            ...
            if (!name.isEmpty()) {
                adapterName = name + PropertyConstants.PROPERTY_DIVIDER + adapterName;
            }
    ...
    public static String getAdapterName(String str) {
        return str.replace(PropertyConstants.PROPERTY_DIVIDER, Extensions.EXTENSION_NAME_DIVIDER) + "_LifecycleAdapter";
    }
