...
public class WorkerWrapper implements Runnable {
    ...
    WorkerWrapper(Builder builder) {
        ...
        this.mWorkSpecId = workSpec.f108id;
                                ...
                                public void run() {
                                    try {
                                        ...
                                        if (result == null) {
                                            ...
                                            logger2.debug(str2, WorkerWrapper.this.mWorkSpec.workerClassName + " returned a " + result + PropertyConstants.PROPERTY_DIVIDER);
    ...
    public /* synthetic */ void m181lambda$runWorker$0$androidxworkimplWorkerWrapper(ListenableFuture listenableFuture) {
