...
public final class WorkerUpdater {
    ...
    public static final void enqueueUniquelyNamedPeriodic$lambda$3(WorkManagerImpl workManagerImpl, String str, OperationImpl operationImpl, Function0 function0, WorkRequest workRequest) {
        ...
        WorkSpec workSpec = workSpecDao.getWorkSpec(idAndState.f109id);
        if (workSpec == null) {
            operationImpl2.markState(new Operation.State.FAILURE(new IllegalStateException("WorkSpec with " + idAndState.f109id + ", that matches a name \"" + str2 + "\", wasn't found")));
            ...
            workSpecDao.delete(idAndState.f109id);
            function0.invoke();
        } else {
            WorkSpec copy$default = WorkSpec.copy$default(workRequest.getWorkSpec(), idAndState.f109id, (WorkInfo.State) null, (String) null, (String) null, (Data) null, (Data) null, 0, 0, 0, (Constraints) null, 0, (BackoffPolicy) null, 0, 0, 0, 0, false, (OutOfQuotaPolicy) null, 0, 0, 1048574, (Object) null);
            try {
                Processor processor = workManagerImpl.getProcessor();
                Intrinsics.checkNotNullExpressionValue(processor, "processor");
                WorkDatabase workDatabase = workManagerImpl.getWorkDatabase();
