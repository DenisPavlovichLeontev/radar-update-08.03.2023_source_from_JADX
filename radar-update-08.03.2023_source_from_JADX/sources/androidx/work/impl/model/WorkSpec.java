...
public final class WorkSpec {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.f108id, (Object) workSpec.f108id) && this.state == workSpec.state && Intrinsics.areEqual((Object) this.workerClassName, (Object) workSpec.workerClassName) && Intrinsics.areEqual((Object) this.inputMergerClassName, (Object) workSpec.inputMergerClassName) && Intrinsics.areEqual((Object) this.input, (Object) workSpec.input) && Intrinsics.areEqual((Object) this.output, (Object) workSpec.output) && this.initialDelay == workSpec.initialDelay && this.intervalDuration == workSpec.intervalDuration && this.flexDuration == workSpec.flexDuration && Intrinsics.areEqual((Object) this.constraints, (Object) workSpec.constraints) && this.runAttemptCount == workSpec.runAttemptCount && this.backoffPolicy == workSpec.backoffPolicy && this.backoffDelayDuration == workSpec.backoffDelayDuration && this.lastEnqueueTime == workSpec.lastEnqueueTime && this.minimumRetentionDuration == workSpec.minimumRetentionDuration && this.scheduleRequestedAt == workSpec.scheduleRequestedAt && this.expedited == workSpec.expedited && this.outOfQuotaPolicy == workSpec.outOfQuotaPolicy && this.periodCount == workSpec.periodCount && this.generation == workSpec.generation;
    }

    public int hashCode() {
        int hashCode = ((((this.f108id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
        int hashCode2 = (((((((((((((((((((((((((hashCode + (str == null ? 0 : str.hashCode())) * 31) + this.input.hashCode()) * 31) + this.output.hashCode()) * 31) + WorkSpec$$ExternalSyntheticBackport0.m48m(this.initialDelay)) * 31) + WorkSpec$$ExternalSyntheticBackport0.m48m(this.intervalDuration)) * 31) + WorkSpec$$ExternalSyntheticBackport0.m48m(this.flexDuration)) * 31) + this.constraints.hashCode()) * 31) + this.runAttemptCount) * 31) + this.backoffPolicy.hashCode()) * 31) + WorkSpec$$ExternalSyntheticBackport0.m48m(this.backoffDelayDuration)) * 31) + WorkSpec$$ExternalSyntheticBackport0.m48m(this.lastEnqueueTime)) * 31) + WorkSpec$$ExternalSyntheticBackport0.m48m(this.minimumRetentionDuration)) * 31) + WorkSpec$$ExternalSyntheticBackport0.m48m(this.scheduleRequestedAt)) * 31;
    ...
    public String toString() {
        return "{WorkSpec: " + this.f108id + '}';
    }

    @Metadata(mo19893d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\b\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\t\u0010\u0007\u001a\u00020\u0003HÆ\u0003J\t\u0010\b\u001a\u00020\u0005HÆ\u0003J\u001d\u0010\t\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005HÆ\u0001J\u0013\u0010\n\u001a\u00020\u000b2\b\u0010\f\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\r\u001a\u00020\u000eHÖ\u0001J\t\u0010\u000f\u001a\u00020\u0003HÖ\u0001R\u0012\u0010\u0002\u001a\u00020\u00038\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0004\u001a\u00020\u00058\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000¨\u0006\u0010"}, mo19894d2 = {"Landroidx/work/impl/model/WorkSpec$IdAndState;", "", "id", "", "state", "Landroidx/work/WorkInfo$State;", "(Ljava/lang/String;Landroidx/work/WorkInfo$State;)V", "component1", "component2", "copy", "equals", "", "other", "hashCode", "", "toString", "work-runtime_release"}, mo19895k = 1, mo19896mv = {1, 7, 1}, mo19898xi = 48)
    /* compiled from: WorkSpec.kt */
    public static final class IdAndState {
        ...
        public boolean equals(Object obj) {
            ...
            return Intrinsics.areEqual((Object) this.f109id, (Object) idAndState.f109id) && this.state == idAndState.state;
        }

        public int hashCode() {
            return (this.f109id.hashCode() * 31) + this.state.hashCode();
        }

        public String toString() {
            return "IdAndState(id=" + this.f109id + ", state=" + this.state + ')';
        }
    ...
    public static final class WorkInfoPojo {
        ...
        public boolean equals(Object obj) {
            ...
            return Intrinsics.areEqual((Object) this.f110id, (Object) workInfoPojo.f110id) && this.state == workInfoPojo.state && Intrinsics.areEqual((Object) this.output, (Object) workInfoPojo.output) && this.runAttemptCount == workInfoPojo.runAttemptCount && this.generation == workInfoPojo.generation && Intrinsics.areEqual((Object) this.tags, (Object) workInfoPojo.tags) && Intrinsics.areEqual((Object) this.progress, (Object) workInfoPojo.progress);
        }

        public int hashCode() {
            return (((((((((((this.f110id.hashCode() * 31) + this.state.hashCode()) * 31) + this.output.hashCode()) * 31) + this.runAttemptCount) * 31) + this.generation) * 31) + this.tags.hashCode()) * 31) + this.progress.hashCode();
        }

        public String toString() {
            return "WorkInfoPojo(id=" + this.f110id + ", state=" + this.state + ", output=" + this.output + ", runAttemptCount=" + this.runAttemptCount + ", generation=" + this.generation + ", tags=" + this.tags + ", progress=" + this.progress + ')';
        }
        ...
        public final WorkInfo toWorkInfo() {
            return new WorkInfo(UUID.fromString(this.f110id), this.state, this.output, this.tags, this.progress.isEmpty() ^ true ? this.progress.get(0) : Data.EMPTY, this.runAttemptCount, this.generation);
        }
    }

    @Metadata(mo19893d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0004¢\u0006\u0002\n\u0000R(\u0010\u0007\u001a\u001a\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u000b0\t0\b8\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, mo19894d2 = {"Landroidx/work/impl/model/WorkSpec$Companion;", "", "()V", "SCHEDULE_NOT_REQUESTED_YET", "", "TAG", "", "WORK_INFO_MAPPER", "Landroidx/arch/core/util/Function;", "", "Landroidx/work/impl/model/WorkSpec$WorkInfoPojo;", "Landroidx/work/WorkInfo;", "work-runtime_release"}, mo19895k = 1, mo19896mv = {1, 7, 1}, mo19898xi = 48)
    /* compiled from: WorkSpec.kt */
