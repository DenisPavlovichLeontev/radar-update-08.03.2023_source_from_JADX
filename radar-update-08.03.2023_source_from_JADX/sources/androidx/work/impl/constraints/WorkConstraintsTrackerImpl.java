    ...
    public void onConstraintMet(List<WorkSpec> list) {
        ...
        synchronized (this.lock) {
            ...
            for (Object next : list) {
                if (areAllConstraintsMet(((WorkSpec) next).f108id)) {
                    arrayList.add(next);
                }
            }
