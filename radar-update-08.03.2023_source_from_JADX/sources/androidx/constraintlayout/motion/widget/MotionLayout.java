...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setState(TransitionState transitionState) {
        if (transitionState != TransitionState.FINISHED || this.mCurrentState != -1) {
            ...
            int i = C01525.f51xabc7e4ac[transitionState2.ordinal()];
            if (i == 1 || i == 2) {
    ...
    static /* synthetic */ class C01525 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.motion.widget.MotionLayout.C01525.<clinit>():void");
        }
    }
    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            String str7 = Proj4Keyword.f419R;
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str4 = Extensions.EXTENSION_NAME_DIVIDER;
        ...
        public void measure(int i, int i2) {
            ...
            if (MotionLayout.this.mCurrentState == MotionLayout.this.getStartState()) {
                ...
                int i4 = (constraintSet5 == null || constraintSet5.mRotate == 0) ? i : i2;
                ConstraintSet constraintSet6 = this.mEnd;
                motionLayout2.resolveSystem(constraintWidgetContainer2, optimizationLevel, i4, (constraintSet6 == null || constraintSet6.mRotate == 0) ? i2 : i);
            }
            if (((MotionLayout.this.getParent() instanceof MotionLayout) && mode == 1073741824 && mode2 == 1073741824) ? false : true) {
                ...
                if (MotionLayout.this.mCurrentState == MotionLayout.this.getStartState()) {
                    ...
                    if (constraintSet7 != null) {
                        MotionLayout.this.resolveSystem(this.mLayoutStart, optimizationLevel, constraintSet7.mRotate == 0 ? i : i2, this.mStart.mRotate == 0 ? i2 : i);
                    }
                } else {
                    ConstraintSet constraintSet8 = this.mStart;
                    if (constraintSet8 != null) {
                        MotionLayout.this.resolveSystem(this.mLayoutStart, optimizationLevel, constraintSet8.mRotate == 0 ? i : i2, this.mStart.mRotate == 0 ? i2 : i);
                    }
                    MotionLayout.this.resolveSystem(this.mLayoutEnd, optimizationLevel, this.mEnd.mRotate == 0 ? i : i2, this.mEnd.mRotate == 0 ? i2 : i);
                }
            ...
            int i5 = MotionLayout.this.mStartWrapWidth;
            int i6 = MotionLayout.this.mStartWrapHeight;
            if (MotionLayout.this.mWidthMeasureMode == Integer.MIN_VALUE || MotionLayout.this.mWidthMeasureMode == 0) {
                i5 = (int) (((float) MotionLayout.this.mStartWrapWidth) + (MotionLayout.this.mPostInterpolationPosition * ((float) (MotionLayout.this.mEndWrapWidth - MotionLayout.this.mStartWrapWidth))));
            }
            int i7 = i5;
            if (MotionLayout.this.mHeightMeasureMode == Integer.MIN_VALUE || MotionLayout.this.mHeightMeasureMode == 0) {
                i6 = (int) (((float) MotionLayout.this.mStartWrapHeight) + (MotionLayout.this.mPostInterpolationPosition * ((float) (MotionLayout.this.mEndWrapHeight - MotionLayout.this.mStartWrapHeight))));
            }
            MotionLayout.this.resolveMeasuredDimension(i, i2, i7, i6, this.mLayoutStart.isWidthMeasuredTooSmall() || this.mLayoutEnd.isWidthMeasuredTooSmall(), this.mLayoutStart.isHeightMeasuredTooSmall() || this.mLayoutEnd.isHeightMeasuredTooSmall());
        }
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0168R.styleable.MotionLayout);
            int indexCount = obtainStyledAttributes.getIndexCount();
            boolean z = true;
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0168R.styleable.MotionLayout_layoutDescription) {
                    this.mScene = new MotionScene(getContext(), this, obtainStyledAttributes.getResourceId(index, -1));
                } else if (index == C0168R.styleable.MotionLayout_currentState) {
                    this.mCurrentState = obtainStyledAttributes.getResourceId(index, -1);
                } else if (index == C0168R.styleable.MotionLayout_motionProgress) {
                    this.mTransitionGoalPosition = obtainStyledAttributes.getFloat(index, 0.0f);
                    this.mInTransition = true;
                } else if (index == C0168R.styleable.MotionLayout_applyMotionScene) {
                    z = obtainStyledAttributes.getBoolean(index, z);
                } else if (index == C0168R.styleable.MotionLayout_showPaths) {
                    if (this.mDebugPath == 0) {
                        this.mDebugPath = obtainStyledAttributes.getBoolean(index, false) ? 2 : 0;
                    }
                } else if (index == C0168R.styleable.MotionLayout_motionDebug) {
    ...
    public void updateStateAnimate(int i, ConstraintSet constraintSet, int i2) {
        if (this.mScene != null && this.mCurrentState == i) {
            updateState(C0168R.C0171id.view_transition, getConstraintSet(i));
            setState(C0168R.C0171id.view_transition, -1, -1);
            updateState(i, constraintSet);
            MotionScene.Transition transition = new MotionScene.Transition(-1, this.mScene, C0168R.C0171id.view_transition, i);
