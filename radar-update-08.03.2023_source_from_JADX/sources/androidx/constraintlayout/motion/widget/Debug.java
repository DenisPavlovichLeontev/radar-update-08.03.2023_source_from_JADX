...
public class Debug {
    ...
    public static String getState(MotionLayout motionLayout, int i, int i2) {
        ...
        return resourceEntryName.replaceAll(CharBuffer.allocate(length2).toString().replace(0, '.') + Extensions.EXTENSION_NAME_DIVIDER, Extensions.EXTENSION_NAME_DIVIDER);
    }
