...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0168R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = obtainStyledAttributes.getString(index);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (index == C0168R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private void addID(String str) {
        if (str != null && str.length() != 0 && this.myContext != null) {
            ...
            Log.w("ConstraintHelper", "Could not find id of \"" + trim + AngleFormat.STR_SEC_SYMBOL);
        }
    }
    ...
    private int findId(String str) {
        ...
        if (i == 0) {
            try {
                i = C0168R.C0171id.class.getField(str).getInt((Object) null);
