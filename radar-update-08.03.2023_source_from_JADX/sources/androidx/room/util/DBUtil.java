...
public final class DBUtil {
    ...
    public static final void dropFtsSyncTriggers(androidx.sqlite.p004db.SupportSQLiteDatabase r6) {
        /*
        ...
        L_0x002a:
            ...
            kotlin.p007io.CloseableKt.closeFinally(r1, r3)
            goto L_0x004a
        L_0x0030:
            r6 = move-exception
        ...
        L_0x0032:
            ...
            throw r0
        L_0x0037:
            boolean r2 = r1.moveToNext()     // Catch:{ all -> 0x0084 }
            if (r2 == 0) goto L_0x0045
            java.lang.String r2 = r1.getString(r4)     // Catch:{ all -> 0x0084 }
            r0.add(r2)     // Catch:{ all -> 0x0084 }
            goto L_0x0037
        L_0x0045:
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0084 }
            r1.close()
        L_0x004a:
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void foreignKeyCheck(androidx.sqlite.p004db.SupportSQLiteDatabase r2, java.lang.String r3) {
        /*
            java.lang.String r0 = "db"
            ...
            r3 = 0
            r0 = r2
            android.database.Cursor r0 = (android.database.Cursor) r0     // Catch:{ all -> 0x0046 }
            int r1 = r0.getCount()     // Catch:{ all -> 0x0046 }
            if (r1 > 0) goto L_0x003c
            kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0046 }
            kotlin.p007io.CloseableKt.closeFinally(r2, r3)
            goto L_0x0058
        L_0x003c:
            java.lang.String r3 = processForeignKeyCheckFailure(r0)     // Catch:{ all -> 0x0046 }
            android.database.sqlite.SQLiteConstraintException r0 = new android.database.sqlite.SQLiteConstraintException     // Catch:{ all -> 0x0046 }
        ...
        L_0x0048:
            ...
            throw r0
        L_0x004d:
            int r3 = r2.getCount()     // Catch:{ all -> 0x0063 }
            if (r3 > 0) goto L_0x0059
            kotlin.Unit r3 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0063 }
            r2.close()
        L_0x0058:
            return
        L_0x0059:
            java.lang.String r3 = processForeignKeyCheckFailure(r2)     // Catch:{ all -> 0x0063 }
            android.database.sqlite.SQLiteConstraintException r0 = new android.database.sqlite.SQLiteConstraintException     // Catch:{ all -> 0x0063 }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0043, code lost:
        kotlin.p007io.CloseableKt.closeFinally(r9, r0);
     */
