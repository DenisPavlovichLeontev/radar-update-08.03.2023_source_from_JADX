...
@Metadata(mo19893d1 = {"\u0000H\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\"\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u001a$\u0010\u0000\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u00012\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0002H\u0002\u001a\u0016\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b2\u0006\u0010\n\u001a\u00020\u000bH\u0002\u001a\u001e\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u000e0\r2\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0002H\u0002\u001a\"\u0010\u000f\u001a\u0004\u0018\u00010\u00102\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0011\u001a\u00020\u00022\u0006\u0010\u0012\u001a\u00020\u0013H\u0002\u001a \u0010\u0014\u001a\n\u0012\u0004\u0012\u00020\u0010\u0018\u00010\r2\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0002H\u0002\u001a\u0018\u0010\u0015\u001a\u00020\u00162\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0002H\u0000¨\u0006\u0017"}, mo19894d2 = {"readColumns", "", "", "Landroidx/room/util/TableInfo$Column;", "database", "Landroidx/sqlite/db/SupportSQLiteDatabase;", "tableName", "readForeignKeyFieldMappings", "", "Landroidx/room/util/TableInfo$ForeignKeyWithSequence;", "cursor", "Landroid/database/Cursor;", "readForeignKeys", "", "Landroidx/room/util/TableInfo$ForeignKey;", "readIndex", "Landroidx/room/util/TableInfo$Index;", "name", "unique", "", "readIndices", "readTableInfo", "Landroidx/room/util/TableInfo;", "room-runtime_release"}, mo19895k = 2, mo19896mv = {1, 7, 1}, mo19898xi = 48)
...
public final class TableInfoKt {
        ...
        if (Build.VERSION.SDK_INT > 15) {
            ...
            try {
                ...
                while (cursor.moveToNext()) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(string2, SVGParser.XML_STYLESHEET_ATTR_TYPE);
            ...
            try {
                ...
                int columnIndex7 = query.getColumnIndex(SVGParser.XML_STYLESHEET_ATTR_TYPE);
                ...
                while (query.moveToNext()) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(string5, SVGParser.XML_STYLESHEET_ATTR_TYPE);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x0086, code lost:
        kotlin.p007io.CloseableKt.closeFinally(r13, r12);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x0089, code lost:
        throw r0;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final java.util.Set<androidx.room.util.TableInfo.Index> readIndices(androidx.sqlite.p004db.SupportSQLiteDatabase r12, java.lang.String r13) {
        /*
            ...
            r0 = r13
            android.database.Cursor r0 = (android.database.Cursor) r0     // Catch:{ all -> 0x0083 }
            int r9 = r0.getColumnIndex(r6)     // Catch:{ all -> 0x0083 }
            int r4 = r0.getColumnIndex(r4)     // Catch:{ all -> 0x0083 }
            int r3 = r0.getColumnIndex(r3)     // Catch:{ all -> 0x0083 }
            if (r9 == r8) goto L_0x007f
            if (r4 == r8) goto L_0x007f
            if (r3 != r8) goto L_0x0044
            goto L_0x007f
        L_0x0044:
            java.util.Set r8 = kotlin.collections.SetsKt.createSetBuilder()     // Catch:{ all -> 0x0083 }
        L_0x0048:
            boolean r10 = r0.moveToNext()     // Catch:{ all -> 0x0083 }
            if (r10 == 0) goto L_0x0077
            java.lang.String r10 = r0.getString(r4)     // Catch:{ all -> 0x0083 }
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r2, (java.lang.Object) r10)     // Catch:{ all -> 0x0083 }
            if (r10 != 0) goto L_0x0059
            goto L_0x0048
        L_0x0059:
            java.lang.String r10 = r0.getString(r9)     // Catch:{ all -> 0x0083 }
            int r11 = r0.getInt(r3)     // Catch:{ all -> 0x0083 }
        ...
        L_0x0065:
            r11 = r1
        L_0x0066:
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r10, r6)     // Catch:{ all -> 0x0083 }
            androidx.room.util.TableInfo$Index r10 = readIndex(r12, r10, r11)     // Catch:{ all -> 0x0083 }
            if (r10 != 0) goto L_0x0073
            kotlin.p007io.CloseableKt.closeFinally(r13, r7)
            return r7
        L_0x0073:
            r8.add(r10)     // Catch:{ all -> 0x0083 }
            goto L_0x0048
        L_0x0077:
            java.util.Set r12 = kotlin.collections.SetsKt.build(r8)     // Catch:{ all -> 0x0083 }
            kotlin.p007io.CloseableKt.closeFinally(r13, r7)
            return r12
        L_0x007f:
            kotlin.p007io.CloseableKt.closeFinally(r13, r7)
        ...
        L_0x0085:
            ...
            throw r0
        L_0x008a:
            int r0 = r13.getColumnIndex(r6)     // Catch:{ all -> 0x00dc }
            int r4 = r13.getColumnIndex(r4)     // Catch:{ all -> 0x00dc }
            int r3 = r13.getColumnIndex(r3)     // Catch:{ all -> 0x00dc }
            if (r0 == r8) goto L_0x00d8
            if (r4 == r8) goto L_0x00d8
            if (r3 != r8) goto L_0x009d
            goto L_0x00d8
        L_0x009d:
            java.util.Set r8 = kotlin.collections.SetsKt.createSetBuilder()     // Catch:{ all -> 0x00dc }
        L_0x00a1:
            boolean r9 = r13.moveToNext()     // Catch:{ all -> 0x00dc }
            if (r9 == 0) goto L_0x00d0
            java.lang.String r9 = r13.getString(r4)     // Catch:{ all -> 0x00dc }
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r2, (java.lang.Object) r9)     // Catch:{ all -> 0x00dc }
            if (r9 != 0) goto L_0x00b2
            goto L_0x00a1
        L_0x00b2:
            java.lang.String r9 = r13.getString(r0)     // Catch:{ all -> 0x00dc }
            int r10 = r13.getInt(r3)     // Catch:{ all -> 0x00dc }
        ...
        L_0x00be:
            r10 = r1
        L_0x00bf:
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r9, r6)     // Catch:{ all -> 0x00dc }
            androidx.room.util.TableInfo$Index r9 = readIndex(r12, r9, r10)     // Catch:{ all -> 0x00dc }
            if (r9 != 0) goto L_0x00cc
            r13.close()
            return r7
        L_0x00cc:
            r8.add(r9)     // Catch:{ all -> 0x00dc }
            goto L_0x00a1
        L_0x00d0:
            java.util.Set r12 = kotlin.collections.SetsKt.build(r8)     // Catch:{ all -> 0x00dc }
            r13.close()
            return r12
        L_0x00d8:
            r13.close()
