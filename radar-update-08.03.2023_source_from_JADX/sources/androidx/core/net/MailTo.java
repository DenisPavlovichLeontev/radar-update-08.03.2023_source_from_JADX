...
public final class MailTo {
    ...
    /* renamed from: CC */
    private static final String f71CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* renamed from: TO */
    private static final String f72TO = "to";
    ...
    public static MailTo parse(String str) throws ParseException {
        ...
        if (isMailTo(str)) {
            ...
            mailTo.mHeaders.put(f72TO, str3);
            return mailTo;
        }
    ...
    public String getTo() {
        return this.mHeaders.get(f72TO);
    }

    public String getCc() {
        return this.mHeaders.get(f71CC);
    }
