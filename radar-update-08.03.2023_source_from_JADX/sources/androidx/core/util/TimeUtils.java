...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        boolean z = i7 != 0;
        int i13 = i12;
        int printField = printField(cArr, i2, AngleFormat.CH_DEG_ABBREV, i12, false, 0);
        int printField2 = printField(cArr, i3, 'h', printField, printField != i13, z ? 2 : 0);
        int printField3 = printField(cArr, i5, AngleFormat.CH_MIN_ABBREV, printField2, printField2 != i13, z ? 2 : 0);
        int printField4 = printField(cArr, i4, 's', printField3, printField3 != i13, z ? 2 : 0);
        int printField5 = printField(cArr, i10, AngleFormat.CH_MIN_ABBREV, printField4, true, (!z || printField4 == i13) ? 0 : 3);
        cArr[printField5] = 's';
