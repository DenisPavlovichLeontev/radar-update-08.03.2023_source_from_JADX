...
public final class Insets {
    ...
    public static Insets add(Insets insets, Insets insets2) {
        return m10of(insets.left + insets2.left, insets.top + insets2.top, insets.right + insets2.right, insets.bottom + insets2.bottom);
    }
    ...
    public static Insets max(Insets insets, Insets insets2) {
        return m10of(Math.max(insets.left, insets2.left), Math.max(insets.top, insets2.top), Math.max(insets.right, insets2.right), Math.max(insets.bottom, insets2.bottom));
    }

    public static Insets min(Insets insets, Insets insets2) {
        return m10of(Math.min(insets.left, insets2.left), Math.min(insets.top, insets2.top), Math.min(insets.right, insets2.right), Math.min(insets.bottom, insets2.bottom));
    }
    ...
    public android.graphics.Insets toPlatformInsets() {
        return Api29Impl.m12of(this.left, this.top, this.right, this.bottom);
    }
