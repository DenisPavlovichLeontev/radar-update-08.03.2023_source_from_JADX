...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, Wbxml.EXT_T_2);
            if (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(Wbxml.EXT_T_2)) {
                return false;
            }
            return true;
            ...
            if (keyCode != 19) {
                if (keyCode != 20) {
                    ...
                    return arrowScroll(Wbxml.EXT_T_2);
                } else {
                    return fullScroll(Wbxml.EXT_T_2);
                }
            } else if (!keyEvent.isAltPressed()) {
