...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    /* renamed from: X */
    public static final ViewProperty f78X = new ViewProperty("x") {
        public void setValue(View view, float f) {
            view.setX(f);
        }
    ...
    /* renamed from: Y */
    public static final ViewProperty f79Y = new ViewProperty("y") {
        public void setValue(View view, float f) {
            view.setY(f);
        }
    ...
    /* renamed from: Z */
    public static final ViewProperty f80Z = new ViewProperty(GeometryColumns.COLUMN_Z) {
        public void setValue(View view, float f) {
