...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        boolean z2 = obtainStyledAttributes.getBoolean(C0418R.styleable.RecyclerView_fastScrollEnabled, false);
    ...
    private String getFullClassName(Context context, String str) {
        ...
        } else if (str.contains(PropertyConstants.PROPERTY_DIVIDER)) {
            return str;
        } else {
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C04621 r0 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
            ...
            C04632 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
                    return LayoutManager.this.getChildAt(i);
                }
