...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
        ...
        if (fragment != null) {
            ...
            if (!fragment.isAdded() && view != null) {
                ...
                if (fragment.isAdded()) {
                    ...
                    beginTransaction.add(fragment, Proj4Keyword.f423f + fragmentViewHolder.getItemId()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
    ...
    class FragmentMaxLifecycleEnforcer {
        ...
        public void register(RecyclerView recyclerView) {
            ...
            C05921 r2 = new ViewPager2.OnPageChangeCallback() {
            ...
            C05932 r22 = new DataSetChangeObserver() {
