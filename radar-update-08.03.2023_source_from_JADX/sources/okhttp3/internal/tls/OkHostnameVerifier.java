...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String str, String str2) {
        ...
        if (!(charSequence == null || charSequence.length() == 0) && !StringsKt.startsWith$default(str, PropertyConstants.PROPERTY_DIVIDER, false, 2, (Object) null) && !StringsKt.endsWith$default(str, "..", false, 2, (Object) null)) {
            CharSequence charSequence2 = str2;
            if (!(charSequence2 == null || charSequence2.length() == 0) && !StringsKt.startsWith$default(str2, PropertyConstants.PROPERTY_DIVIDER, false, 2, (Object) null) && !StringsKt.endsWith$default(str2, "..", false, 2, (Object) null)) {
                if (!StringsKt.endsWith$default(str, PropertyConstants.PROPERTY_DIVIDER, false, 2, (Object) null)) {
                    str = Intrinsics.stringPlus(str, PropertyConstants.PROPERTY_DIVIDER);
                }
                if (!StringsKt.endsWith$default(str2, PropertyConstants.PROPERTY_DIVIDER, false, 2, (Object) null)) {
                    str2 = Intrinsics.stringPlus(str2, PropertyConstants.PROPERTY_DIVIDER);
                }
