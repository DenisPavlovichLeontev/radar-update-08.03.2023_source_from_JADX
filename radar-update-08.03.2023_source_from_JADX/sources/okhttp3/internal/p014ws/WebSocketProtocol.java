...
public final class WebSocketProtocol {
    ...
    public final void toggleMask(Buffer.UnsafeCursor unsafeCursor, byte[] bArr) {
        ...
        Intrinsics.checkNotNullParameter(bArr, DatabaseFileArchive.COLUMN_KEY);
