...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
            ...
            if (StringsKt.equals("Upgrade", header$default, true)) {
                ...
                if (StringsKt.equals("websocket", header$default2, true)) {
                    ...
                    if (!Intrinsics.areEqual((Object) base64, (Object) header$default3)) {
                        throw new ProtocolException("Expected 'Sec-WebSocket-Accept' header value '" + base64 + "' but was '" + header$default3 + AngleFormat.CH_MIN_SYMBOL);
                    } else if (exchange == null) {
                        throw new ProtocolException("Web Socket exchange missing: bad interceptor?");
                    }
                } else {
                    throw new ProtocolException("Expected 'Upgrade' header value 'websocket' but was '" + header$default2 + AngleFormat.CH_MIN_SYMBOL);
                }
            } else {
                throw new ProtocolException("Expected 'Connection' header value 'Upgrade' but was '" + header$default + AngleFormat.CH_MIN_SYMBOL);
            }
        } else {
            throw new ProtocolException("Expected HTTP 101 response but was '" + response.code() + ' ' + response.message() + AngleFormat.CH_MIN_SYMBOL);
        }
    }
    ...
    public synchronized void onReadPing(okio.ByteString r2) {
        ...
        L_0x0029:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p014ws.RealWebSocket.onReadPing(okio.ByteString):void");
    }
    ...
    public void onReadClose(int r6, java.lang.String r7) {
        ...
        L_0x0095:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p014ws.RealWebSocket.onReadClose(int, java.lang.String):void");
    }
    ...
    private final synchronized boolean send(okio.ByteString r7, int r8) {
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p014ws.RealWebSocket.send(okio.ByteString, int):boolean");
    }
    ...
    public final synchronized boolean close(int r8, java.lang.String r9, long r10) {
        /*
            r7 = this;
            monitor-enter(r7)
            okhttp3.internal.ws.WebSocketProtocol r0 = okhttp3.internal.p014ws.WebSocketProtocol.INSTANCE     // Catch:{ all -> 0x004e }
        ...
        L_0x004e:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p014ws.RealWebSocket.close(int, java.lang.String, long):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x007e, code lost:
        if ((r5 instanceof okhttp3.internal.p014ws.RealWebSocket.Message) == false) goto L_0x00a6;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x0080, code lost:
        r5 = (okhttp3.internal.p014ws.RealWebSocket.Message) r5;
        kotlin.jvm.internal.Intrinsics.checkNotNull(r0);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x00a8, code lost:
        if ((r5 instanceof okhttp3.internal.p014ws.RealWebSocket.Close) == false) goto L_0x00e0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:43:0x00aa, code lost:
        r5 = (okhttp3.internal.p014ws.RealWebSocket.Close) r5;
        kotlin.jvm.internal.Intrinsics.checkNotNull(r0);
    ...
    public final boolean writeOneFrame$okhttp() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r7 = r6 instanceof okhttp3.internal.p014ws.RealWebSocket.Close     // Catch:{ all -> 0x0100 }
        ...
        L_0x003b:
            r4 = r6
            okhttp3.internal.ws.RealWebSocket$Close r4 = (okhttp3.internal.p014ws.RealWebSocket.Close) r4     // Catch:{ all -> 0x0100 }
        ...
        L_0x006e:
            ...
            goto L_0x00c7
        L_0x007c:
            boolean r2 = r5 instanceof okhttp3.internal.p014ws.RealWebSocket.Message     // Catch:{ all -> 0x00e6 }
            if (r2 == 0) goto L_0x00a6
            okhttp3.internal.ws.RealWebSocket$Message r5 = (okhttp3.internal.p014ws.RealWebSocket.Message) r5     // Catch:{ all -> 0x00e6 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x00e6 }
        ...
        L_0x00a6:
            boolean r2 = r5 instanceof okhttp3.internal.p014ws.RealWebSocket.Close     // Catch:{ all -> 0x00e6 }
            if (r2 == 0) goto L_0x00e0
            okhttp3.internal.ws.RealWebSocket$Close r5 = (okhttp3.internal.p014ws.RealWebSocket.Close) r5     // Catch:{ all -> 0x00e6 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x00e6 }
        ...
        L_0x0100:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p014ws.RealWebSocket.writeOneFrame$okhttp():boolean");
    }
    ...
    public final void writePingFrame$okhttp() {
        ...
        L_0x005d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p014ws.RealWebSocket.writePingFrame$okhttp():void");
    }
    ...
    public final void failWebSocket(java.lang.Exception r6, okhttp3.Response r7) {
        ...
        L_0x0061:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p014ws.RealWebSocket.failWebSocket(java.lang.Exception, okhttp3.Response):void");
    }

    @Metadata(mo19893d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u000b"}, mo19894d2 = {"Lokhttp3/internal/ws/RealWebSocket$Message;", "", "formatOpcode", "", "data", "Lokio/ByteString;", "(ILokio/ByteString;)V", "getData", "()Lokio/ByteString;", "getFormatOpcode", "()I", "okhttp"}, mo19895k = 1, mo19896mv = {1, 6, 0}, mo19898xi = 48)
    ...
    @Metadata(mo19893d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\b\b\u0000\u0018\u00002\u00020\u0001B\u001f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0013\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, mo19894d2 = {"Lokhttp3/internal/ws/RealWebSocket$Close;", "", "code", "", "reason", "Lokio/ByteString;", "cancelAfterCloseMillis", "", "(ILokio/ByteString;J)V", "getCancelAfterCloseMillis", "()J", "getCode", "()I", "getReason", "()Lokio/ByteString;", "okhttp"}, mo19895k = 1, mo19896mv = {1, 6, 0}, mo19898xi = 48)
    ...
    @Metadata(mo19893d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\b\b&\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0006\u001a\u00020\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\fR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u000f"}, mo19894d2 = {"Lokhttp3/internal/ws/RealWebSocket$Streams;", "Ljava/io/Closeable;", "client", "", "source", "Lokio/BufferedSource;", "sink", "Lokio/BufferedSink;", "(ZLokio/BufferedSource;Lokio/BufferedSink;)V", "getClient", "()Z", "getSink", "()Lokio/BufferedSink;", "getSource", "()Lokio/BufferedSource;", "okhttp"}, mo19895k = 1, mo19896mv = {1, 6, 0}, mo19898xi = 48)
    ...
    @Metadata(mo19893d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016¨\u0006\u0005"}, mo19894d2 = {"Lokhttp3/internal/ws/RealWebSocket$WriterTask;", "Lokhttp3/internal/concurrent/Task;", "(Lokhttp3/internal/ws/RealWebSocket;)V", "runOnce", "", "okhttp"}, mo19895k = 1, mo19896mv = {1, 6, 0}, mo19898xi = 48)
    ...
    @Metadata(mo19893d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0014\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\bX\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, mo19894d2 = {"Lokhttp3/internal/ws/RealWebSocket$Companion;", "", "()V", "CANCEL_AFTER_CLOSE_MILLIS", "", "DEFAULT_MINIMUM_DEFLATE_SIZE", "MAX_QUEUE_SIZE", "ONLY_HTTP1", "", "Lokhttp3/Protocol;", "okhttp"}, mo19895k = 1, mo19896mv = {1, 6, 0}, mo19898xi = 48)
