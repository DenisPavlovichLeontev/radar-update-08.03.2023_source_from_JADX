...
class SVGParser {
    ...
    private static class FontWeightKeywords {
        ...
        static {
            ...
            hashMap.put("400", 400);
            hashMap.put("500", 500);
            hashMap.put("600", Integer.valueOf(TypedValues.Motion.TYPE_STAGGER));
            hashMap.put("700", 700);
            hashMap.put("800", 800);
    ...
    private void parseUsingSAX(InputStream inputStream) throws SVGParseException {
        ...
        try {
            ...
            SAXHandler sAXHandler = new SAXHandler(this, (C07021) null);
    ...
    private class SAXHandler extends DefaultHandler2 {
        ...
        /* synthetic */ SAXHandler(SVGParser sVGParser, C07021 r2) {
            this();
        }
    ...
    public void startElement(String str, String str2, String str3, Attributes attributes) throws SVGParseException {
        if (this.ignoring) {
            ...
            switch (C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGElem[fromString.ordinal()]) {
                case 1:
                    svg(attributes);
                    return;
                case 2:
    ...
    public void endElement(String str, String str2, String str3) throws SVGParseException {
        ...
        if (SVG_NAMESPACE.equals(str) || "".equals(str)) {
            ...
            int i2 = C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGElem[SVGElem.fromString(str2).ordinal()];
    ...
    public Map<String, String> parseProcessingInstructionAttributes(TextScanner textScanner) {
        ...
        while (nextToken != null) {
            textScanner.consume((char) Tag.KEY_VALUE_SEPARATOR);
    ...
    private void parseAttributesSVG(SVG.Svg svg, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                svg.f174x = parseLength(trim);
            } else if (i2 == 2) {
                svg.f175y = parseLength(trim);
            } else if (i2 == 3) {
    ...
    static /* synthetic */ class C07021 {
        ...
        static {
            ...
            L_0x057d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.caverock.androidsvg.SVGParser.C07021.<clinit>():void");
        }
    }

    /* renamed from: g */
    private void m50g(Attributes attributes) throws SVGParseException {
    ...
    private void parseAttributesUse(SVG.Use use, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                use.f198x = parseLength(trim);
            } else if (i2 == 2) {
                use.f199y = parseLength(trim);
            } else if (i2 == 3) {
    ...
    private void parseAttributesImage(SVG.Image image, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                image.f159x = parseLength(trim);
            } else if (i2 == 2) {
                image.f160y = parseLength(trim);
            } else if (i2 == 3) {
    ...
    private void parseAttributesRect(SVG.Rect rect, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                rect.f172x = parseLength(trim);
            } else if (i2 == 2) {
                rect.f173y = parseLength(trim);
            } else if (i2 == 3) {
                ...
                rect.f170rx = parseLength(trim);
                if (rect.f170rx.isNegative()) {
                    throw new SVGParseException("Invalid <rect> element. rx cannot be negative");
                }
            } else if (i2 != 11) {
                continue;
            } else {
                rect.f171ry = parseLength(trim);
                if (rect.f171ry.isNegative()) {
    ...
    private void parseAttributesCircle(SVG.Circle circle, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (SVGAttr.fromString(attributes.getLocalName(i))) {
                case cx:
                    circle.f152cx = parseLength(trim);
                    break;
                case cy:
                    circle.f153cy = parseLength(trim);
                    break;
                case r:
                    circle.f154r = parseLength(trim);
                    if (!circle.f154r.isNegative()) {
                        break;
                    } else {
    ...
    private void parseAttributesEllipse(SVG.Ellipse ellipse, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (SVGAttr.fromString(attributes.getLocalName(i))) {
                case rx:
                    ellipse.f157rx = parseLength(trim);
                    if (!ellipse.f157rx.isNegative()) {
                        break;
                    } else {
                        throw new SVGParseException("Invalid <ellipse> element. rx cannot be negative");
                    }
                case ry:
                    ellipse.f158ry = parseLength(trim);
                    if (!ellipse.f158ry.isNegative()) {
                        break;
                    } else {
                        throw new SVGParseException("Invalid <ellipse> element. ry cannot be negative");
                    }
                case cx:
                    ellipse.f155cx = parseLength(trim);
                    break;
                case cy:
                    ellipse.f156cy = parseLength(trim);
                    break;
            }
        }
    }
    ...
    private void parseAttributesLine(SVG.Line line, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (SVGAttr.fromString(attributes.getLocalName(i))) {
                case x1:
                    line.f161x1 = parseLength(trim);
                    break;
                case y1:
                    line.f163y1 = parseLength(trim);
                    break;
                case x2:
                    line.f162x2 = parseLength(trim);
                    break;
                case y2:
                    line.f164y2 = parseLength(trim);
                    break;
            }
        }
    }
    ...
    private void parseAttributesTextPosition(SVG.TextPositionedContainer textPositionedContainer, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                textPositionedContainer.f188x = parseLengthList(trim);
            } else if (i2 == 2) {
                textPositionedContainer.f189y = parseLengthList(trim);
            } else if (i2 == 19) {
                textPositionedContainer.f186dx = parseLengthList(trim);
            } else if (i2 == 20) {
                textPositionedContainer.f187dy = parseLengthList(trim);
            }
        }
    }
    ...
    private void parseAttributesTRef(SVG.TRef tRef, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            String trim = attributes.getValue(i).trim();
            if (C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 6 && ("".equals(attributes.getURI(i)) || XLINK_NAMESPACE.equals(attributes.getURI(i)))) {
                tRef.href = trim;
            }
        }
    }
    ...
    private void parseAttributesGradient(com.caverock.androidsvg.SVG.GradientElement r6, org.xml.sax.Attributes r7) throws com.caverock.androidsvg.SVGParseException {
        ...
        L_0x0002:
            ...
            int[] r3 = com.caverock.androidsvg.SVGParser.C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr
    ...
    private void parseAttributesLinearGradient(SVG.SvgLinearGradient svgLinearGradient, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (SVGAttr.fromString(attributes.getLocalName(i))) {
                case x1:
                    svgLinearGradient.f177x1 = parseLength(trim);
                    break;
                case y1:
                    svgLinearGradient.f179y1 = parseLength(trim);
                    break;
                case x2:
                    svgLinearGradient.f178x2 = parseLength(trim);
                    break;
                case y2:
                    svgLinearGradient.f180y2 = parseLength(trim);
                    break;
            }
        }
    }
    ...
    private void parseAttributesRadialGradient(com.caverock.androidsvg.SVG.SvgRadialGradient r5, org.xml.sax.Attributes r6) throws com.caverock.androidsvg.SVGParseException {
        ...
        L_0x0001:
            ...
            int[] r2 = com.caverock.androidsvg.SVGParser.C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr
        ...
        L_0x002b:
            ...
            r5.f185r = r1
            com.caverock.androidsvg.SVG$Length r1 = r5.f185r
    ...
    private void parseAttributesStop(SVG.Stop stop, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String trim = attributes.getValue(i).trim();
            if (C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 37) {
    ...
    private void parseAttributesClipPath(SVG.ClipPath clipPath, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String trim = attributes.getValue(i).trim();
            if (C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 38) {
    ...
    private void parseAttributesMask(SVG.Mask mask, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07021.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                mask.f165x = parseLength(trim);
            } else if (i2 == 2) {
                mask.f166y = parseLength(trim);
            } else if (i2 == 3) {
    ...
    private void parseAttributesCore(SVG.SvgElementBase svgElementBase, Attributes attributes) throws SVGParseException {
        ...
        while (i < attributes.getLength()) {
            ...
            if (qName.equals("id") || qName.equals("xml:id")) {
                svgElementBase.f176id = attributes.getValue(i).trim();
                return;
