...
public class SVG {
    ...
    private String cssQuotedString(String str) {
        if (str.startsWith(AngleFormat.STR_SEC_SYMBOL) && str.endsWith(AngleFormat.STR_SEC_SYMBOL)) {
            str = str.substring(1, str.length() - 1).replace("\\\"", AngleFormat.STR_SEC_SYMBOL);
    ...
    static class Length implements Cloneable {
        ...
        public float floatValueX(SVGAndroidRenderer sVGAndroidRenderer) {
            switch (C06991.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()]) {
                case 1:
                    return this.value;
                case 2:
        ...
        public float floatValue(float f) {
            int i = C06991.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()];
            if (i == 1) {
                return this.value;
            }
            switch (i) {
    ...
    static /* synthetic */ class C06991 {
        ...
        static {
            ...
            L_0x006c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.caverock.androidsvg.SVG.C06991.<clinit>():void");
        }
    }
    ...
    public SvgElementBase getElementById(String str) {
        ...
        if (str.equals(this.rootElement.f176id)) {
            return this.rootElement;
        }
    ...
    private SvgElementBase getElementById(SvgContainer svgContainer, String str) {
        ...
        if (str.equals(svgElementBase.f176id)) {
        ...
        for (SvgObject next : svgContainer.getChildren()) {
            if (next instanceof SvgElementBase) {
                ...
                if (str.equals(svgElementBase2.f176id)) {
