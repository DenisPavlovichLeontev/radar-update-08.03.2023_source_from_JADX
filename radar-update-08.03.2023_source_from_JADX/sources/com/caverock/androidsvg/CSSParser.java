...
class CSSParser {
    ...
    /* renamed from: ID */
    private static final String f146ID = "id";
        ...
        public String toString() {
            ...
            if (list != null) {
                for (Attrib next : list) {
                    sb.append('[');
                    sb.append(next.name);
                    int i = C06971.$SwitchMap$com$caverock$androidsvg$CSSParser$AttribOp[next.operation.ordinal()];
                    if (i == 1) {
    ...
    private static class CSSTextScanner extends SVGParser.TextScanner {
        ...
        public List<Selector> nextSelectorGroup() throws CSSParseException {
            ...
            Selector selector = new Selector((C06971) null);
            while (!empty() && nextSimpleSelector(selector)) {
                if (skipCommaWhitespace()) {
                    arrayList.add(selector);
                    selector = new Selector((C06971) null);
                }
            }
            if (!selector.isEmpty()) {
                arrayList.add(selector);
        ...
        private AnPlusB nextAnPlusB() throws CSSParseException {
            ...
            if (consume("odd")) {
                ...
                if (consume("even")) {
                    ...
                    if (consume('n') || consume((char) AngleFormat.CH_N)) {
                        if (parseInt == null) {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v6, resolved type: com.caverock.androidsvg.CSSParser$PseudoClassAnPlusB} */
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v8, resolved type: com.caverock.androidsvg.CSSParser$PseudoClassNot} */
        ...
        /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v10, resolved type: com.caverock.androidsvg.CSSParser$PseudoClassAnPlusB} */
        ...
        private void parsePseudoClass(com.caverock.androidsvg.CSSParser.Selector r21, com.caverock.androidsvg.CSSParser.SimpleSelector r22) throws com.caverock.androidsvg.CSSParseException {
            /*
                ...
                int[] r3 = com.caverock.androidsvg.CSSParser.C06971.$SwitchMap$com$caverock$androidsvg$CSSParser$PseudoClassIdents
                int r4 = r2.ordinal()
                r3 = r3[r4]
    ...
    static /* synthetic */ class C06971 {
        ...
        static {
            ...
            L_0x0145:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.caverock.androidsvg.CSSParser.C06971.<clinit>():void");
        }
    }
    ...
    static class RuleMatchContext {
        ...
        public String toString() {
            ...
            return String.format("<%s id=\"%s\">", new Object[]{svgElementBase.getNodeName(), this.targetElement.f176id});
        }
    }
    ...
    private static boolean selectorMatch(RuleMatchContext ruleMatchContext, SimpleSelector simpleSelector, List<SVG.SvgContainer> list, int i, SVG.SvgElementBase svgElementBase) {
        ...
        if (simpleSelector.attribs != null) {
            for (Attrib next : simpleSelector.attribs) {
                ...
                } else if (!next.value.equals(svgElementBase.f176id)) {
                    return false;
                }
            }
        }
    ...
    private static class PseudoClassAnPlusB implements PseudoClass {
        ...
        public boolean matches(RuleMatchContext ruleMatchContext, SVG.SvgElementBase svgElementBase) {
            ...
            if (i4 != 0) {
                ...
                if (Integer.signum(i3 - i5) == 0 || Integer.signum(i3 - this.f151b) == Integer.signum(this.f150a)) {
                    return true;
                }
                return false;
            } else if (i3 == this.f151b) {
                return true;
            } else {
                return false;
            }
        ...
        public String toString() {
            ...
            if (this.isOfType) {
                return String.format("nth-%schild(%dn%+d of type <%s>)", new Object[]{str, Integer.valueOf(this.f150a), Integer.valueOf(this.f151b), this.nodeName});
            }
            return String.format("nth-%schild(%dn%+d)", new Object[]{str, Integer.valueOf(this.f150a), Integer.valueOf(this.f151b)});
        }
    }
    ...
    private static class PseudoClassRoot implements PseudoClass {
        ...
        /* synthetic */ PseudoClassRoot(C06971 r1) {
            this();
        }
    ...
    private static class PseudoClassEmpty implements PseudoClass {
        ...
        /* synthetic */ PseudoClassEmpty(C06971 r1) {
            this();
        }
    ...
    private static class PseudoClassTarget implements PseudoClass {
        ...
        /* synthetic */ PseudoClassTarget(C06971 r1) {
            this();
        }
