...
public final class DynamiteModule {
    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            throw new LoadingException("No acceptable module " + str2 + " found. Local version is " + selectModule.localVersion + " and remote version is " + selectModule.remoteVersion + PropertyConstants.PROPERTY_DIVIDER, (zzp) null);
        } finally {
            if (longValue == 0) {
                zzh.remove();
            } else {
    ...
    private static boolean zzf(Context context) {
        ...
        if (zzf == null) {
            ...
            if (z && resolveContentProvider != null && resolveContentProvider.applicationInfo != null && (resolveContentProvider.applicationInfo.flags & Wbxml.EXT_T_1) == 0) {
