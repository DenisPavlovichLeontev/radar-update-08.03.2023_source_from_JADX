...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        float unused = pathLineOperation.f267x = f;
        float unused2 = pathLineOperation.f268y = f2;
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        if ((Math.abs(f - getEndX()) >= 0.001f || Math.abs(f2 - getEndY()) >= 0.001f) && (Math.abs(f - f3) >= 0.001f || Math.abs(f2 - f4) >= 0.001f)) {
            ...
            float unused3 = pathLineOperation2.f267x = f3;
            float unused4 = pathLineOperation2.f268y = f4;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f268y - this.startY), (double) (this.operation.f267x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f268y - this.startY) / (this.operation.f267x - this.startX))));
        }
    }
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            if (sweepAngle <= 0.0f) {
                double hypot = Math.hypot((double) (this.operation1.f267x - this.startX), (double) (this.operation1.f268y - this.startY));
                double hypot2 = Math.hypot((double) (this.operation2.f267x - this.operation1.f267x), (double) (this.operation2.f268y - this.operation1.f268y));
                ...
                this.renderMatrix.set(matrix2);
                this.renderMatrix.preTranslate(this.operation1.f267x, this.operation1.f268y);
                this.renderMatrix.preRotate(getStartAngle());
        ...
        public float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation1.f268y - this.startY) / (this.operation1.f267x - this.startX))));
        }

        /* access modifiers changed from: package-private */
        public float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation2.f268y - this.operation1.f268y) / (this.operation2.f267x - this.operation1.f267x))));
        }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f267x, this.f268y);
