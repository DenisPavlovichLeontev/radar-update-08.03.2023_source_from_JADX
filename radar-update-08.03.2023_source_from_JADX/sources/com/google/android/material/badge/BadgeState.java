...
public final class BadgeState {
    ...
    BadgeState(Context context, int i, int i2, int i3, State state) {
        ...
        this.badgeRadius = (float) generateTypedArray.getDimensionPixelSize(C0710R.styleable.Badge_badgeRadius, resources.getDimensionPixelSize(C0710R.dimen.mtrl_badge_radius));
        this.badgeWidePadding = (float) generateTypedArray.getDimensionPixelSize(C0710R.styleable.Badge_badgeWidePadding, resources.getDimensionPixelSize(C0710R.dimen.mtrl_badge_long_text_horizontal_padding));
        this.badgeWithTextRadius = (float) generateTypedArray.getDimensionPixelSize(C0710R.styleable.Badge_badgeWithTextRadius, resources.getDimensionPixelSize(C0710R.dimen.mtrl_badge_with_text_radius));
        int unused2 = state2.alpha = state.alpha == -2 ? 255 : state.alpha;
        if (state.contentDescriptionNumberless == null) {
            charSequence = context.getString(C0710R.string.mtrl_badge_numberless_content_description);
        } else {
        ...
        if (state.contentDescriptionQuantityStrings == 0) {
            i4 = C0710R.plurals.mtrl_badge_content_description;
        } else {
        ...
        if (state.contentDescriptionExceedsMaxBadgeNumberRes == 0) {
            i5 = C0710R.string.mtrl_exceed_max_badge_number_content_description;
        } else {
        ...
        if (state.maxCharacterCount == -2) {
            i6 = generateTypedArray.getInt(C0710R.styleable.Badge_maxCharacterCount, 4);
        } else {
        ...
        } else if (generateTypedArray.hasValue(C0710R.styleable.Badge_number)) {
            int unused9 = state2.number = generateTypedArray.getInt(C0710R.styleable.Badge_number, 0);
        } else {
            int unused10 = state2.number = -1;
        }
        if (state.backgroundColor == null) {
            i7 = readColorFromAttributes(context, generateTypedArray, C0710R.styleable.Badge_backgroundColor);
        } else {
        ...
        } else if (generateTypedArray.hasValue(C0710R.styleable.Badge_badgeTextColor)) {
            Integer unused13 = state2.badgeTextColor = Integer.valueOf(readColorFromAttributes(context, generateTypedArray, C0710R.styleable.Badge_badgeTextColor));
        } else {
            Integer unused14 = state2.badgeTextColor = Integer.valueOf(new TextAppearance(context, C0710R.style.TextAppearance_MaterialComponents_Badge).getTextColor().getDefaultColor());
        }
        if (state.badgeGravity == null) {
            i8 = generateTypedArray.getInt(C0710R.styleable.Badge_badgeGravity, 8388661);
        } else {
        ...
        if (state.horizontalOffsetWithoutText == null) {
            i9 = generateTypedArray.getDimensionPixelOffset(C0710R.styleable.Badge_horizontalOffset, 0);
        } else {
        ...
        if (state.verticalOffsetWithoutText == null) {
            i10 = generateTypedArray.getDimensionPixelOffset(C0710R.styleable.Badge_verticalOffset, 0);
        } else {
        ...
        if (state.horizontalOffsetWithText == null) {
            i11 = generateTypedArray.getDimensionPixelOffset(C0710R.styleable.Badge_horizontalOffsetWithText, state2.horizontalOffsetWithoutText.intValue());
        } else {
        ...
        if (state.verticalOffsetWithText == null) {
            i12 = generateTypedArray.getDimensionPixelOffset(C0710R.styleable.Badge_verticalOffsetWithText, state2.verticalOffsetWithoutText.intValue());
        } else {
    ...
    private TypedArray generateTypedArray(Context context, int i, int i2, int i3) {
        ...
        return ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C0710R.styleable.Badge, i2, i4 == 0 ? i3 : i4, new int[0]);
    }
