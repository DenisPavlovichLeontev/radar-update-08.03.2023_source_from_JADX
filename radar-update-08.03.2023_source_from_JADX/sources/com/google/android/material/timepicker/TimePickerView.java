...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
        ...
        this.selectionListener = new View.OnClickListener() {
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C0710R.C0713id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C0710R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C0710R.C0713id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C0710R.C0713id.material_clock_period_toggle);
        this.toggle = materialButtonToggleGroup;
        materialButtonToggleGroup.addOnButtonCheckedListener(new TimePickerView$$ExternalSyntheticLambda0(this));
        this.minuteView = (Chip) findViewById(C0710R.C0713id.material_minute_tv);
        this.hourView = (Chip) findViewById(C0710R.C0713id.material_hour_tv);
        this.clockHandView = (ClockHandView) findViewById(C0710R.C0713id.material_clock_hand);
        setupDoubleTap();
        setUpDisplay();
    }
    ...
    public /* synthetic */ void mo18606x9f44237d(MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z) {
        if (z && this.onPeriodChangeListener != null) {
            this.onPeriodChangeListener.onPeriodChange(i == C0710R.C0713id.material_clock_period_pm_button ? 1 : 0);
        }
    }
    ...
    private void setupDoubleTap() {
        ...
        C09433 r1 = new View.OnTouchListener() {
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C0710R.C0713id.selection_type, 12);
        this.hourView.setTag(C0710R.C0713id.selection_type, 10);
    ...
    public void updateTime(int i, int i2, int i3) {
        int i4;
        if (i == 1) {
            i4 = C0710R.C0713id.material_clock_period_pm_button;
        } else {
            i4 = C0710R.C0713id.material_clock_period_am_button;
        }
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C0710R.C0713id.material_clock_display, i);
