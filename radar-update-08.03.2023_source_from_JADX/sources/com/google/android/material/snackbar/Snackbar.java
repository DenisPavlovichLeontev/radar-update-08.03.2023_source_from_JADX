...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0710R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0710R.attr.snackbarButtonStyle, C0710R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            ...
            if (hasSnackbarContentStyleAttrs(context)) {
                i2 = C0710R.layout.mtrl_layout_snackbar_include;
            } else {
                i2 = C0710R.layout.design_layout_snackbar_include;
            }
    ...
    public /* synthetic */ void m184lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener onClickListener, View view) {
