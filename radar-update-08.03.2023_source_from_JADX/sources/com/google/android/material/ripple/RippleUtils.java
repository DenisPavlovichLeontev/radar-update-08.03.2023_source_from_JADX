...
public class RippleUtils {
    ...
    private static class RippleUtilsLollipop {
        ...
        public static Drawable createOvalRipple(Context context, int i) {
            ...
            return new RippleDrawable(MaterialColors.getColorStateList(context, C0710R.attr.colorControlHighlight, ColorStateList.valueOf(0)), (Drawable) null, new InsetDrawable(gradientDrawable, i, i, i, i));
        }
    }
}
