...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    DateFormatTextWatcher(String str, DateFormat dateFormat2, TextInputLayout textInputLayout2, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout2.getContext().getString(C0710R.string.mtrl_picker_out_of_range);
    ...
    public /* synthetic */ void mo16375x5657fb8e(String str) {
        TextInputLayout textInputLayout2 = this.textInputLayout;
        DateFormat dateFormat2 = this.dateFormat;
        Context context = textInputLayout2.getContext();
        String string = context.getString(C0710R.string.mtrl_picker_invalid_format);
        String format = String.format(context.getString(C0710R.string.mtrl_picker_invalid_format_use), new Object[]{sanitizeDateString(str)});
        String format2 = String.format(context.getString(C0710R.string.mtrl_picker_invalid_format_example), new Object[]{sanitizeDateString(dateFormat2.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())))});
    ...
    public /* synthetic */ void mo16374x14d77527(long j) {
