...
class FloatingActionButtonImpl {
    ...
    private static final int HIDE_ANIM_DURATION_ATTR = C0710R.attr.motionDurationMedium1;
    private static final int HIDE_ANIM_EASING_ATTR = C0710R.attr.motionEasingEmphasizedAccelerateInterpolator;
    ...
    private static final int SHOW_ANIM_DURATION_ATTR = C0710R.attr.motionDurationLong2;
    private static final int SHOW_ANIM_EASING_ATTR = C0710R.attr.motionEasingEmphasizedInterpolator;
    ...
    private AnimatorSet createDefaultAnimator(float f, float f2, float f3, int i, int i2) {
        ...
        arrayList.add(ofFloat);
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
        animatorSet.setDuration((long) MotionUtils.resolveThemeDuration(this.view.getContext(), i, this.view.getContext().getResources().getInteger(C0710R.integer.material_motion_duration_long_1)));
