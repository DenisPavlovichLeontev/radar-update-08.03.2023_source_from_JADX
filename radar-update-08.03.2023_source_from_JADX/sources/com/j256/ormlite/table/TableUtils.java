...
public class TableUtils {
    ...
    private static <T, ID> int doCreateTable(ConnectionSource connectionSource, TableInfo<T, ID> tableInfo, boolean z) throws SQLException {
        ...
        DatabaseConnection readWriteConnection = connectionSource.getReadWriteConnection(tableInfo.getTableName());
        try {
            return doStatements(readWriteConnection, RTreeIndexCoreExtension.CREATE_PROPERTY, arrayList, false, databaseType.isCreateTableReturnsNegative(), databaseType.isCreateTableReturnsZero()) + doCreateTestQueries(readWriteConnection, databaseType, arrayList2);
        } finally {
            connectionSource.releaseConnection(readWriteConnection);
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x006f A[ADDED_TO_REGION] */
    ...
    private static int doStatements(com.j256.ormlite.support.DatabaseConnection r14, java.lang.String r15, java.util.Collection<java.lang.String> r16, boolean r17, boolean r18, boolean r19) throws java.sql.SQLException {
        ...
        L_0x0009:
            ...
            r13 = 0
            com.j256.ormlite.stmt.StatementBuilder$StatementType r8 = com.j256.ormlite.stmt.StatementBuilder.StatementType.EXECUTE     // Catch:{ SQLException -> 0x0038 }
            com.j256.ormlite.field.FieldType[] r9 = noFieldTypes     // Catch:{ SQLException -> 0x0038 }
            r10 = -1
            r11 = 0
            r6 = r14
            r7 = r12
            com.j256.ormlite.support.CompiledStatement r13 = r6.compileStatement(r7, r8, r9, r10, r11)     // Catch:{ SQLException -> 0x0038 }
            int r6 = r13.runExecute()     // Catch:{ SQLException -> 0x0038 }
        ...
        L_0x0097:
            ...
            r1.append(r12)     // Catch:{ all -> 0x0035 }
