...
import com.j256.ormlite.p006db.BaseDatabaseType;
    ...
    static /* synthetic */ class C10061 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.j256.ormlite.p006db.BaseSqliteDatabaseType.C10061.<clinit>():void");
        }
    }

    public FieldConverter getFieldConverter(DataPersister dataPersister, FieldType fieldType) {
        int i = C10061.$SwitchMap$com$j256$ormlite$field$SqlType[dataPersister.getSqlType().ordinal()];
        if (i == 1) {
