package com.j256.ormlite.p006db;
...
public abstract class BaseDatabaseType implements DatabaseType {
    ...
    public void loadDriver() throws SQLException {
        ...
        if (driverClassName != null) {
            try {
                ...
                throw SqlExceptionUtil.create("Driver class was not found for " + getDatabaseName() + " database.  Missing jar with class " + driverClassName + PropertyConstants.PROPERTY_DIVIDER, e);
            }
        }
    }
    ...
    public void appendColumnArg(String str, StringBuilder sb, FieldType fieldType, List<String> list, List<String> list2, List<String> list3, List<String> list4) throws SQLException {
        ...
        switch (C10051.$SwitchMap$com$j256$ormlite$field$SqlType[dataPersister.getSqlType().ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class C10051 {
        ...
        static {
            ...
            L_0x00cc:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.j256.ormlite.p006db.BaseDatabaseType.C10051.<clinit>():void");
        }
    }
