...
public class DatabaseFieldConfig {
    ...
    public static DatabaseFieldConfig fromDatabaseField(DatabaseType databaseType, String str, Field field, DatabaseField databaseField) {
        ...
        databaseFieldConfig.f281id = databaseField.mo19322id();
    ...
    private String findIndexName(String str) {
        if (this.columnName == null) {
            return str + Extensions.EXTENSION_NAME_DIVIDER + this.fieldName + "_idx";
        }
        return str + Extensions.EXTENSION_NAME_DIVIDER + this.columnName + "_idx";
    }
