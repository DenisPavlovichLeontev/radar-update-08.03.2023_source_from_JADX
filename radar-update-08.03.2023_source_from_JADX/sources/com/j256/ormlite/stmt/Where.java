...
import com.j256.ormlite.stmt.query.C1017In;
...
public class Where<T, ID> {
    ...
    /* renamed from: eq */
    public Where<T, ID> mo19710eq(String str, Object obj) throws SQLException {
        addClause(new SimpleComparison(str, findColumnFieldType(str), obj, SimpleComparison.EQUAL_TO_OPERATION));
        return this;
    }

    /* renamed from: ge */
    public Where<T, ID> mo19712ge(String str, Object obj) throws SQLException {
        addClause(new SimpleComparison(str, findColumnFieldType(str), obj, SimpleComparison.GREATER_THAN_EQUAL_TO_OPERATION));
        return this;
    }

    /* renamed from: gt */
    public Where<T, ID> mo19714gt(String str, Object obj) throws SQLException {
        addClause(new SimpleComparison(str, findColumnFieldType(str), obj, SimpleComparison.GREATER_THAN_OPERATION));
        return this;
    }

    /* renamed from: in */
    public Where<T, ID> mo19718in(String str, Iterable<?> iterable) throws SQLException {
        addClause(new C1017In(str, findColumnFieldType(str), iterable, true));
        return this;
    }

    public Where<T, ID> notIn(String str, Iterable<?> iterable) throws SQLException {
        addClause(new C1017In(str, findColumnFieldType(str), iterable, false));
        return this;
    }

    /* renamed from: in */
    public Where<T, ID> mo19719in(String str, Object... objArr) throws SQLException {
        return m96in(true, str, objArr);
    }

    public Where<T, ID> notIn(String str, Object... objArr) throws SQLException {
        return m96in(false, str, objArr);
    }

    /* renamed from: in */
    public Where<T, ID> mo19717in(String str, QueryBuilder<?, ?> queryBuilder) throws SQLException {
        return m95in(true, str, queryBuilder);
    }

    public Where<T, ID> notIn(String str, QueryBuilder<?, ?> queryBuilder) throws SQLException {
        return m95in(false, str, queryBuilder);
    }
    ...
    /* renamed from: le */
    public Where<T, ID> mo19723le(String str, Object obj) throws SQLException {
        addClause(new SimpleComparison(str, findColumnFieldType(str), obj, SimpleComparison.LESS_THAN_EQUAL_TO_OPERATION));
        return this;
    }

    /* renamed from: lt */
    public Where<T, ID> mo19725lt(String str, Object obj) throws SQLException {
    ...
    /* renamed from: ne */
    public Where<T, ID> mo19726ne(String str, Object obj) throws SQLException {
    ...
    /* renamed from: or */
    public Where<T, ID> mo19734or(Where<T, ID> where, Where<T, ID> where2, Where<T, ID>... whereArr) {
    ...
    /* renamed from: or */
    public Where<T, ID> mo19733or(int i) {
        if (i != 0) {
            Clause[] clauseArr = new Clause[i];
            while (true) {
                i--;
    ...
    /* renamed from: in */
    private Where<T, ID> m96in(boolean z, String str, Object... objArr) throws SQLException {
        if (objArr.length == 1) {
            String str2 = "IN";
        ...
        addClause(new C1017In(str, findColumnFieldType(str), objArr, z));
        return this;
    }

    /* renamed from: in */
    private Where<T, ID> m95in(boolean z, String str, QueryBuilder<?, ?> queryBuilder) throws SQLException {
