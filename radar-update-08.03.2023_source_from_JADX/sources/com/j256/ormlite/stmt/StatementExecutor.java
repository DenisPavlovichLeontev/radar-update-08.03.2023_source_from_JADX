...
public class StatementExecutor<T, ID> implements GenericRowMapper<String[]> {
    ...
    public long queryForLong(com.j256.ormlite.support.DatabaseConnection r7, com.j256.ormlite.stmt.PreparedStmt<T> r8) throws java.sql.SQLException {
        /*
            ...
            r2 = 0
            com.j256.ormlite.support.DatabaseResults r2 = r7.runQuery(r2)     // Catch:{ all -> 0x003c }
            boolean r3 = r2.first()     // Catch:{ all -> 0x003c }
            if (r3 == 0) goto L_0x0021
            r8 = 0
            long r3 = r2.getLong(r8)     // Catch:{ all -> 0x003c }
            com.j256.ormlite.misc.IOUtils.closeThrowSqlException(r2, r1)
            com.j256.ormlite.misc.IOUtils.closeThrowSqlException(r7, r0)
            return r3
        L_0x0021:
            java.sql.SQLException r3 = new java.sql.SQLException     // Catch:{ all -> 0x003c }
            ...
            java.lang.String r8 = r8.getStatement()     // Catch:{ all -> 0x003c }
            r4.append(r8)     // Catch:{ all -> 0x003c }
            java.lang.String r8 = r4.toString()     // Catch:{ all -> 0x003c }
            r3.<init>(r8)     // Catch:{ all -> 0x003c }
    ...
    private <CT> CT doCallBatchTasks(com.j256.ormlite.support.ConnectionSource r5, java.util.concurrent.Callable<CT> r6) throws java.sql.SQLException {
        /*
            ...
            r1 = 0
            java.lang.ThreadLocal<java.lang.Boolean> r2 = r4.localIsInBatchMode     // Catch:{ all -> 0x0038 }
            r3 = 1
            java.lang.Boolean r3 = java.lang.Boolean.valueOf(r3)     // Catch:{ all -> 0x0038 }
            r2.set(r3)     // Catch:{ all -> 0x0038 }
            boolean r2 = r5.saveSpecialConnection(r0)     // Catch:{ all -> 0x0038 }
            java.lang.Object r6 = r4.doCallBatchTasks(r0, r2, r6)     // Catch:{ all -> 0x0036 }
    ...
    private <CT> CT doCallBatchTasks(com.j256.ormlite.support.DatabaseConnection r6, boolean r7, java.util.concurrent.Callable<CT> r8) throws java.sql.SQLException {
        ...
        L_0x0011:
            r7 = 0
            r1 = 1
            boolean r2 = r6.isAutoCommitSupported()     // Catch:{ all -> 0x0053 }
            if (r2 == 0) goto L_0x0034
            boolean r2 = r6.isAutoCommit()     // Catch:{ all -> 0x0053 }
            if (r2 == 0) goto L_0x0034
            r6.setAutoCommit(r7)     // Catch:{ all -> 0x0053 }
        ...
        L_0x0031:
            ...
            goto L_0x0057
        L_0x0034:
            java.lang.Object r8 = r8.call()     // Catch:{ SQLException -> 0x0051, Exception -> 0x0049 }
        ...
        L_0x0049:
            ...
            java.sql.SQLException r8 = com.j256.ormlite.misc.SqlExceptionUtil.create(r2, r8)     // Catch:{ all -> 0x0053 }
    ...
    public boolean ifExists(DatabaseConnection databaseConnection, ID id) throws SQLException {
        if (this.ifExistsQuery == null) {
            ...
            queryBuilder.where().mo19710eq(this.tableInfo.getIdField().getColumnName(), new SelectArg());
