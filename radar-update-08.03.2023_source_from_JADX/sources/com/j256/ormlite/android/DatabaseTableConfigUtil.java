...
public class DatabaseTableConfigUtil {
    ...
    /* renamed from: ID */
    private static final int f280ID = 6;
    ...
    private static int[] lookupClasses() {
        /*
            ...
            java.lang.Class r1 = java.lang.Class.forName(r1)     // Catch:{  }
            java.lang.Class<?> r2 = annotationFactoryClazz     // Catch:{ ClassNotFoundException -> 0x008a }
            java.lang.String r3 = "elements"
            java.lang.reflect.Field r2 = r2.getDeclaredField(r3)     // Catch:{ ClassNotFoundException -> 0x008a }
            elementsField = r2     // Catch:{ ClassNotFoundException -> 0x008a }
            r3 = 1
            r2.setAccessible(r3)     // Catch:{ ClassNotFoundException -> 0x008a }
            java.lang.Class<?> r2 = annotationMemberClazz     // Catch:{ ClassNotFoundException -> 0x008a }
            java.lang.String r4 = "name"
            java.lang.reflect.Field r2 = r2.getDeclaredField(r4)     // Catch:{ ClassNotFoundException -> 0x008a }
            nameField = r2     // Catch:{ ClassNotFoundException -> 0x008a }
            r2.setAccessible(r3)     // Catch:{ ClassNotFoundException -> 0x008a }
            java.lang.Class<?> r2 = annotationMemberClazz     // Catch:{ ClassNotFoundException -> 0x008a }
            java.lang.String r4 = "value"
            java.lang.reflect.Field r2 = r2.getDeclaredField(r4)     // Catch:{ ClassNotFoundException -> 0x008a }
            valueField = r2     // Catch:{ ClassNotFoundException -> 0x008a }
            r2.setAccessible(r3)     // Catch:{ ClassNotFoundException -> 0x008a }
