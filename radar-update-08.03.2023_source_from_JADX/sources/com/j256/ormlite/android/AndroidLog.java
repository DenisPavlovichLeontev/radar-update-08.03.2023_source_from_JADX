...
public class AndroidLog implements Log {
    ...
    static /* synthetic */ class C09951 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.j256.ormlite.android.AndroidLog.C09951.<clinit>():void");
        }
    }

    public void log(Log.Level level, String str) {
        switch (C09951.$SwitchMap$com$j256$ormlite$logger$Log$Level[level.ordinal()]) {
            case 1:
    ...
    private int levelToAndroidLevel(Log.Level level) {
        int i = C09951.$SwitchMap$com$j256$ormlite$logger$Log$Level[level.ordinal()];
        if (i == 1) {
            return 2;
        }
        if (i == 2) {
