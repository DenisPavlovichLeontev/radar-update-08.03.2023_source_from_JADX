...
import com.j256.ormlite.p006db.SqliteAndroidDatabaseType;
...
public class OrmLiteConfigUtil {
    ...
    public static void writeConfigFile(String str) throws SQLException, IOException {
        ...
        findAnnotatedClasses(arrayList, new File(PropertyConstants.PROPERTY_DIVIDER), 0);
    ...
    public static void writeConfigFile(String str, Class<?>[] clsArr) throws SQLException, IOException {
        File findRawDir = findRawDir(new File(PropertyConstants.PROPERTY_DIVIDER));
        if (findRawDir == null) {
    ...
    public static void writeConfigFile(File file) throws SQLException, IOException {
        writeConfigFile(file, new File(PropertyConstants.PROPERTY_DIVIDER));
    }
        ...
        for (File file2 : file.listFiles()) {
            if (file2.isDirectory()) {
                ...
                if (packageOfClass == null) {
                    ...
                    try {
                        Class<?> cls = Class.forName(packageOfClass + PropertyConstants.PROPERTY_DIVIDER + name.substring(0, name.length() - 5));
