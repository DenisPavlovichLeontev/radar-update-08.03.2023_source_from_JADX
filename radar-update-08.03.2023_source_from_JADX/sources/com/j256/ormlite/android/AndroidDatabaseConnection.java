...
public class AndroidDatabaseConnection implements DatabaseConnection {
    ...
    /* renamed from: db */
    private final SQLiteDatabase f279db;
    ...
    public boolean isAutoCommit() throws SQLException {
        try {
            boolean inTransaction = this.f279db.inTransaction();
    ...
    public void setAutoCommit(boolean z) {
        if (z) {
            if (this.f279db.inTransaction()) {
                this.f279db.setTransactionSuccessful();
                this.f279db.endTransaction();
            }
        } else if (!this.f279db.inTransaction()) {
            this.f279db.beginTransaction();
        }
    }
    ...
    public int executeStatement(String str, int i) throws SQLException {
        return AndroidCompiledStatement.execSql(this.f279db, str, str, NO_STRING_ARGS);
    }
    ...
    public CompiledStatement compileStatement(String str, StatementBuilder.StatementType statementType, FieldType[] fieldTypeArr, int i, boolean z) {
        AndroidCompiledStatement androidCompiledStatement = new AndroidCompiledStatement(str, this.f279db, statementType, this.cancelQueriesEnabled, z);
    ...
    public int insert(String str, Object[] objArr, FieldType[] fieldTypeArr, GeneratedKeyHolder generatedKeyHolder) throws SQLException {
        try {
            SQLiteStatement compileStatement = this.f279db.compileStatement(str);
    ...
    public <T> Object queryForOne(String str, Object[] objArr, FieldType[] fieldTypeArr, GenericRowMapper<T> genericRowMapper, ObjectCache objectCache) throws SQLException {
        ...
        T t2 = null;
        try {
            cursor = this.f279db.rawQuery(str, toStrings(objArr));
            try {
    ...
    public long queryForLong(String str) throws SQLException {
        ...
        try {
            sQLiteStatement = this.f279db.compileStatement(str);
    ...
    public void close() throws IOException {
        try {
            this.f279db.close();
            logger.trace("{}: db {} closed", (Object) this, (Object) this.f279db);
        } catch (android.database.SQLException e) {
    ...
    public boolean isClosed() throws SQLException {
        try {
            boolean isOpen = this.f279db.isOpen();
            logger.trace("{}: db {} isOpen returned {}", (Object) this, (Object) this.f279db, (Object) Boolean.valueOf(isOpen));
            return !isOpen;
        } catch (android.database.SQLException e) {
    ...
    public boolean isTableExists(String str) {
        SQLiteDatabase sQLiteDatabase = this.f279db;
    ...
    private int update(String str, Object[] objArr, FieldType[] fieldTypeArr, String str2) throws SQLException {
        ...
        try {
            ...
            try {
                ...
                closeQuietly(compileStatement);
                try {
                    sQLiteStatement = this.f279db.compileStatement("SELECT CHANGES()");
        ...
        if (objArr != null) {
            for (int i = 0; i < objArr.length; i++) {
                ...
                if (bArr == null) {
                    ...
                    switch (C09941.$SwitchMap$com$j256$ormlite$field$SqlType[sqlType.ordinal()]) {
                        case 1:
                        case 2:
                        case 3:
    ...
    static /* synthetic */ class C09941 {
        ...
        static {
            ...
            L_0x00c0:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.j256.ormlite.android.AndroidDatabaseConnection.C09941.<clinit>():void");
        }
    }
