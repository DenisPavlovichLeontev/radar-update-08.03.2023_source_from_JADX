...
public class Entities {
    ...
    static void escape(Appendable appendable, String str, Document.OutputSettings outputSettings, boolean z, boolean z2, boolean z3, boolean z4) throws IOException {
                        ...
                        if (c != '>') {
                            if (c != 160) {
                                if (c < ' ' || !canEncode(coreCharset, c, encoder)) {
                                    appendEncoded(appendable2, escapeMode, codePointAt);
                                } else {
                                    appendable2.append(c);
                                }
    ...
    static /* synthetic */ class C12081 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jsoup.nodes.Entities.C12081.<clinit>():void");
        }
    }

    private static boolean canEncode(CoreCharset coreCharset, char c, CharsetEncoder charsetEncoder) {
        int i = C12081.$SwitchMap$org$jsoup$nodes$Entities$CoreCharset[coreCharset.ordinal()];
        if (i != 1) {
            if (i != 2) {
    ...
    public static void load(EscapeMode escapeMode, String str, int i) {
        ...
        while (!characterReader.isEmpty()) {
            try {
                String consumeTo = characterReader.consumeTo((char) Tag.KEY_VALUE_SEPARATOR);
