...
public abstract class Node implements Cloneable {
    ...
    public Node forEachNode(Consumer<? super Node> consumer) {
        ...
        NodeTraversor.traverse((NodeVisitor) new Node$$ExternalSyntheticLambda0(consumer), this);
        return this;
    }
    ...
    public void indent(Appendable appendable, int i, Document.OutputSettings outputSettings) throws IOException {
        appendable.append(10).append(StringUtil.padding(i * outputSettings.indentAmount(), outputSettings.maxPaddingWidth()));
    }
