...
enum TokeniserState {
    ...
    BeforeAttributeName {
        ...
        public void read(org.jsoup.parser.Tokeniser r3, org.jsoup.parser.CharacterReader r4) {
            ...
            L_0x007d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jsoup.parser.TokeniserState.C126334.read(org.jsoup.parser.Tokeniser, org.jsoup.parser.CharacterReader):void");
        }
    },
    AttributeName {
        /* access modifiers changed from: package-private */
    ...
    AttributeValue_singleQuoted {
        ...
        public void read(Tokeniser tokeniser, CharacterReader characterReader) {
            ...
            if (consume == 0) {
                ...
                int[] consumeCharacterReference = tokeniser.consumeCharacterReference(Character.valueOf(AngleFormat.CH_MIN_SYMBOL), true);
                if (consumeCharacterReference != null) {
                    tokeniser.tagPending.appendAttributeValue(consumeCharacterReference);
                } else {
                    tokeniser.tagPending.appendAttributeValue((char) Typography.amp);
    ...
    static {
        attributeNameCharsSorted = new char[]{9, 10, 12, 13, ' ', Typography.quote, AngleFormat.CH_MIN_SYMBOL, '/', Typography.less, Tag.KEY_VALUE_SEPARATOR, Typography.greater};
        attributeValueUnquoted = new char[]{0, 9, 10, 12, 13, ' ', Typography.quote, Typography.amp, AngleFormat.CH_MIN_SYMBOL, Typography.less, Tag.KEY_VALUE_SEPARATOR, Typography.greater, '`'};
