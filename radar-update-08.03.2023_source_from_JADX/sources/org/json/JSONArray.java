...
public class JSONArray implements Iterable<Object> {
    ...
    public boolean getBoolean(int i) throws JSONException {
        ...
        throw wrongValueFormatException(i, TypedValues.Custom.S_BOOLEAN, obj, (Throwable) null);
    }
    ...
    public float getFloat(int i) throws JSONException {
        ...
        try {
            ...
            throw wrongValueFormatException(i, TypedValues.Custom.S_FLOAT, obj, e);
        }
    }
    ...
    public <E extends Enum<E>> E getEnum(Class<E> cls, int i) throws JSONException {
        ...
        throw wrongValueFormatException(i, "enum of type " + JSONObject.quote(cls.getSimpleName()), opt(i), (Throwable) null);
    }
    ...
    public JSONArray getJSONArray(int i) throws JSONException {
        ...
        throw wrongValueFormatException(i, "JSONArray", obj, (Throwable) null);
    }
    ...
    public JSONObject getJSONObject(int i) throws JSONException {
        ...
        throw wrongValueFormatException(i, "JSONObject", obj, (Throwable) null);
    }
    ...
    public String getString(int i) throws JSONException {
        ...
        throw wrongValueFormatException(i, "String", obj, (Throwable) null);
    }
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (obj2 != obj3) {
                ...
                if (obj2 instanceof JSONObject) {
                    ...
                    if (!(obj2 instanceof JSONString) || !(obj3 instanceof JSONString)) {
                        if (!obj2.equals(obj3)) {
                            return false;
                        }
                    } else if (!((JSONString) obj2).toJSONString().equals(((JSONString) obj3).toJSONString())) {
                        return false;
                    }
                } else if (!JSONObject.isNumberSimilar((Number) obj2, (Number) obj3)) {
                    return false;
                }
            }
        }
    ...
    private void addAll(Object obj, boolean z) throws JSONException {
        if (obj.getClass().isArray()) {
            ...
            addAll((Collection<?>) (Collection) obj, z);
        } else if (obj instanceof Iterable) {
            addAll((Iterable<?>) (Iterable) obj, z);
        } else {
            throw new JSONException("JSONArray initial value should be a string or collection or array.");
        }
    }
